...
export default function AccountScreen(): React.ReactElement {
  ...
  const stats = [
    {
      label: "Tickets",
      value: MY_TICKETS.length.toString(),
      icon: "ticket-outline",
    },
    {
      label: "Events",
      ...
      items: [
        {
          ...
          value:
            themeMode === "system"
              ? `System (${actualScheme === "dark" ? "Dark" : "Light"})`
        ...
        },
        {
          ...
          value: language === "en" ? "English" : "ភាសាខ្មែរ",
      ...
      items: [
        {
          ...
          onPress: () =>
            Alert.alert(
              "Help Center",
              "Visit support.proget.com for assistance"
            ),
        },
        {
        ...
        },
        {
          ...
          onPress: () => Alert.alert("Terms", "View at proget.com/terms"),
        },
        {
          label: "About",
    ...
    >
      ...
      >
        ...
        <TouchableOpacity
          activeOpacity={0.7}
          onPress={() =>
            Alert.alert("Edit Profile", "Edit your profile information")
          }
            ...
            {section.items.map((item, itemIndex) => (
              ...
              >
                ...
                <View style={styles.listItemRight}>
                  {item.value && (
                    <Text
                      style={[styles.listItemValue, { color: theme.muted }]}
                    >
                      {item.value}
                    </Text>
                  )}
      ...
      <TouchableOpacity
        ...
        style={[
          styles.logoutButton,
          { backgroundColor: theme.card, borderColor: "#ef4444" },
        ]}
      >
          ...
          >
            ...
            >
              ...
              <Text style={[styles.modalDescription, { color: theme.muted }]}>
                Choose how the app looks. System will sync with your phone's
                theme.
              </Text>
              ...
              <View style={styles.themeOptions}>
                {[
                  ...
                  },
                  {
                    ...
                    description: "Sync with phone settings",
                  },
                ].map((option) => {
