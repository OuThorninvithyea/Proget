...
export default function HomeScreen(): React.ReactElement {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      if (!mounted) return;
      if (q) setQuery(q);
      if (t === "all" || t === "live" || t === "nearby" || t === "free")
        setTab(t);
    ...
    >
      ...
      >
        <Text style={{ color: theme.text, fontWeight: "700" }}>
          Live Ticket Concerts
        </Text>
        <Text style={{ color: theme.muted, fontSize: 12 }}>
          Find shows near you and book in seconds.
        </Text>
      </View>
      ...
      {loading || refreshing ? (
        <Carousel>
          {Array.from({ length: 3 }).map((_, i) => (
            ...
            >
              <View
                style={[styles.skelImage, { backgroundColor: theme.border }]}
              />
              <View style={styles.skelMeta}>
                ...
                <View
                  style={[
                    styles.skelLine,
                    { width: "40%", backgroundColor: theme.border },
                  ]}
                />
              </View>
            </View>
            ...
            >
              ...
              <View style={styles.skelMeta}>
                <View
                  style={[
                    styles.skelLine,
                    { width: "60%", backgroundColor: theme.border },
                  ]}
                />
                <View
                  style={[
                    styles.skelLine,
                    { width: "35%", backgroundColor: theme.border },
                  ]}
                />
              </View>
            </View>
